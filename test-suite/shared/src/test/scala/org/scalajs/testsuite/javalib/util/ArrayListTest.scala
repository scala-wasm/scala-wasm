...
class ArrayListTest extends AbstractListTest {
  ...
  @Test def equalsForNonEmptyLists(): Unit = {
    val ne1a = factory.fromElements[Int](TrivialImmutableCollection(1, 2, 3))
    val ne1b = factory.fromElements[Int](TrivialImmutableCollection(1, 2, 3))
    val ne2 = factory.fromElements[Int](TrivialImmutableCollection(1))
  ...
  @Test def trimToSizeForNonEmptyListsWithDifferentCapacities(): Unit = {
    val al1 = factory.fromElements[Int](TrivialImmutableCollection(1, 2, 3))
    val al2 = factory.fromElements[Int](TrivialImmutableCollection(1, 2, 3))
  ...
  @Test def indexOfAny(): Unit = {
    val al1 = factory.fromElements[Int](TrivialImmutableCollection(1, 2, 3, 2))
  ...
  @Test def toArrayArrayWhenArrayIsShorter(): Unit = {
    val al1 = factory.fromElements[String](TrivialImmutableCollection("apple", "banana", "cherry"))
  ...
  @Test def arrayEToArrayTWhenTSubE(): Unit = {
    ...
    val al1 = factory.fromElements[SubClass](in)
  ...
  @Test def removeInt(): Unit = {
    val al1 = factory.fromElements[Int](TrivialImmutableCollection(1, 2, 3, 2, 3))
    // remove last
  ...
  @Test def containsAny(): Unit = {
    val al = factory.fromElements[Int](TrivialImmutableCollection(1, 2, 3, 2))
...
class ArrayListFactory extends AbstractListFactory {
  ...
  def fromElements[E](coll: ju.Collection[E]): ju.ArrayList[E] =
