...
object Serializers {
  ...
  private final class Serializer {
    ...
    def writeWITType(tpe: wit.WasmInterfaceType): Unit = tpe match {
      ...
      case wit.RecordTypeRef(className, scope, name) =>
      ...
      case wit.VariantTypeRef(className, scope, name) =>
        buffer.writeByte(TagWITVariantType)
        writeName(className)
        writeWitScope(scope)
        writeString(name)
      case wit.EnumTypeRef(className, scope, name) =>
      ...
      case wit.FlagsTypeRef(className, scope, name) =>
        buffer.writeByte(TagWITFlagsType)
        writeName(className)
        writeWitScope(scope)
        writeString(name)
      case wit.ResourceType(resource, ownership) =>
    ...
    private def readWITType(): wit.ValType = {
      ...
      tag match {
        ...
        case TagWITVariantType =>
          ...
          val scope = readWitScope()
          val name = readString()
          wit.VariantTypeRef(className, scope, name)
        case TagWITEnumType =>
          val className = readClassName()
          val scope = readWitScope()
          val name = readString()
          wit.EnumTypeRef(className, scope, name)
        ...
        case TagWITResourceType =>
          ...
          wit.ResourceType(className, scope, name, ownership)
      }
    }
