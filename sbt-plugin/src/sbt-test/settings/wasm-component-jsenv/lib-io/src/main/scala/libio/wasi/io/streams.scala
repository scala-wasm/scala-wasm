package libio.wasi.io

import libio.wasi.io.error.Error
...
package object streams {
  ...
  object StreamError {
    ...
    final class LastOperationFailed(@WitName("value") val value: Error)
        extends StreamError {
  ...
  final class OutputStream private () extends Object {
    ...
    def blockingWriteAndFlush(@WitName("contents") contents: Array[UByte]): Result[Unit, StreamError] = native
